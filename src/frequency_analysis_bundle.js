  ...
  render () {
    ...
    return (
      <div className='clearfix'>
        <h6><b>&nbsp;&nbsp;&nbsp;&nbsp;Fréquences des <i style={numberStyle}>{frequencyCount}</i> symboles les plus fréquents, parmi {<i style={numberStyle}>{totalChars}</i>} presents dans le message après application du masque ET.</b></h6>
