...
2. Copy `server-modules` folder to a subfolder of `bebras-server-modules` folder, for instance into  `bebras-server-modules/tasks/enigma/`
3. Add the task to bebras-server-modules, for instance: go to `bebras-server-modules` folder and then run `node command.js tasks:add http://concours-alkindi.fr/tasks/2018/enigma tasks/enigma/server-modules/index.js`(the task ID `http://concours-alkindi.fr/tasks/2018/enigma` can be changed)
